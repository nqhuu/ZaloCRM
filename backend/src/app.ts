...
import { startZaloDelegationCron } from './modules/zalo/zalo-delegation-cron.js';
...
import { startArchiveBackupWorker } from './modules/archive/archive-backup-worker.js';
import { startArchiveReminder } from './modules/archive/archive-reminder.js';
import { publicStorageRoutes } from './modules/storage/public-storage-routes.js';
...
async function bootstrap() {
  ...
  await app.register(publicStorageRoutes);
  ...
  try {
    ...
    startArchiveBackupWorker(io);
    startArchiveReminder(io);

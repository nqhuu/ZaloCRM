...
export const RESOURCE_ACTIONS: Record<Resource, readonly Action[]> = {
  ...
  archive: ['access', 'create', 'edit', 'delete', 'approve', 'view_all'],
};
...
export const DEFAULT_PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    grants: {
      ...
      archive: { access: true, create: true, edit: true, delete: true, approve: true },
  ...
  },
  {
    ...
    grants: {
      ...
      archive: { access: true, create: true, edit: true },
